...
import tiendacarro.Modelo.registro_viaje_modelo;
...
public class controlador_general {
        ...
        for (chofer_modelo ch : lista_choferes) {
            if (ch.getCedula_chofer().equals(cedula)) {
                try {
                    ...
                    return "Chofer actualizado exitosamente: " + nombre + " | Cédula: " + cedula + " | Licencia: "
                            + licencia;
                } catch (IllegalArgumentException e) {
                    return e.getMessage();
                }
    ...
    public String registrar_viaje(String placa, String numero_serie, String cedula_chofer, String cedula_pasajero) {
        ...
        if (carroEncontrado == null || motorEncontrado == null || choferEncontrado == null
        ...
        try {
            registro_viaje_modelo nuevoViaje = new registro_viaje_modelo(carroEncontrado, motorEncontrado,
                    choferEncontrado, pasajeroEncontrado);
    ...
    public String enviar_datos_viajes() {
        ...
        for (int i = 0; i < lista_viajes.size(); i++) {
            ...
            sb.append("Chofer (CI)   : ").append(v.getChofer().getCedula_chofer()).append(" - ")
                    .append(v.getChofer().getNombre_chofer()).append("\n");
            sb.append("Pasajero (CI) : ").append(v.getPasajero().getCedula_pasajero()).append(" - ")
                    .append(v.getPasajero().getNombre_pasajero()).append("\n");
        }
        return sb.toString().trim();
    }
}
