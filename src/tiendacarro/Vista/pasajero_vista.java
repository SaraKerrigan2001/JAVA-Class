...
import tiendacarro.Controlador.controlador_general;
import java.util.Scanner;

public class pasajero_vista {

    private controlador_general obj_controlador;

    public pasajero_vista() {
        this.obj_controlador = controlador_general.getInstance();
    }
        ...
        while (!salir) {
            ...
            switch (opcion) {
                case "1":
                    ...
                    break;
                case "2":
                    System.out.println("\n" + obj_controlador.enviar_datos_pasajero());
                    break;
                case "3":
